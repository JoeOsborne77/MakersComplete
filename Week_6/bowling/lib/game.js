...
class Game {
  ...
  addFrame(roll1, roll2) {
    ...
    if (this.frames.length === 10) this.frames.push(new Frame(roll1, roll2))
    this.frames.forEach((fr, idx) => {
      if (idx === 8 && fr.roll1 === 10|| fr.roll1 + fr.roll2 === 10) 
      this.frames.push(new Frame(roll1))
    })
  }
